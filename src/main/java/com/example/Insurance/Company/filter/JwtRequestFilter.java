...
/**
 * This class is a filter that intercepts incoming HTTP requests to validate the JWT token in the Authorization header.
 * If the token is valid, it sets the authentication in the SecurityContextHolder.
 * This filter is executed once per request.
 */
package com.example.Insurance.Company.filter;
